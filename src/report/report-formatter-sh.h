...
#ifndef _REPORT_FORMATTER_SH_H_
#define _REPORT_FORMATTER_SH_H_
...
class report_formatter_sh: public report_formatter_string_base
{
public:
	report_formatter_sh();
